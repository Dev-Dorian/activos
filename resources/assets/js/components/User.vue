                        ...
                        <div class="modal-body">
                          ...
                          <!--  <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="num_documento" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" placeholder="Número de documento">                                        
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="telefono" onkeypress='return event.charCode >= 48 && event.charCode <= 57' class="form-control" placeholder="Teléfono">
                                    </div>
                                </div>  -->
                                <div class="form-group row">
    ...
    export default {
        ...
        methods : {
            ...
            validarUser(){
                ...
                if (!this.nombre) this.errorMostrarMsjUser.push("El nombre del usuario no puede estar vacío.");
